    ...
    return (
        <div className="bg-black/20 border-x border-b border-panel-border p-6 shadow-inner text-sm animate-in fade-in slide-in-from-top-2 duration-200">
            <div className="flex justify-between items-center mb-4">
                <h4 className="text-white font-semibold uppercase tracking-wider text-xs">Section A: AI Reasoning</h4>
                <div className="flex items-center gap-2">
                    <span className="text-xs text-brand-slate uppercase tracking-wider font-semibold">Analysis Timestamp:</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    <h4 className="text-white font-semibold mb-3 uppercase tracking-wider text-xs">Section B: ML Anomaly Scores</h4>
                ...
                <div>
                    <h4 className="text-white font-semibold mb-3 uppercase tracking-wider text-xs">Section D: Log Intelligence</h4>
                    <div className="bg-panel-bg p-4 rounded border border-panel-border space-y-2">
                        <div className="flex justify-between">
